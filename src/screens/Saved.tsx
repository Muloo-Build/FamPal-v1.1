              ...
              {savedPlaces.map(place => {
                ...
                return (
                  <div
                    ...
                    className="bg-white rounded-2xl border border-slate-100 shadow-[0_2px_12px_rgb(0,0,0,0.04)] overflow-hidden hover:shadow-[0_4px_20px_rgb(0,0,0,0.08)] active:scale-[0.98] transition-all cursor-pointer"
                  >
